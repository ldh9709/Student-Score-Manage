...
public class ResponseStatusCode {
    ...
    public static final int DELETED_TEACHER_SUCCESS = 2003; // 회원 삭제 성공
    ...
    public static final int DELETED_STUDENT_SUCCESS = 2103; // 학생 삭제 성공
    ...
    public static final int DELETED_SCORE_SUCCESS = 2203; // 성적 삭제 성공
    ...
    public static final int DELETED_SCORE_TYPE_SUCCESS = 2303; // 성적 유형 삭제 성공
    ...
    public static final int DELETED_SCHOOL_SUCCESS = 2403; // 학교 삭제 성공
    ...
    public static final int DELETED_GRADE_SUCCESS = 2503; // 학년 삭제 성공
    ...
    public static final int DELETED_GRADE_AVG_SUCCESS = 2603; // 학년 평균 삭제 성공
    ...
    /******************* 일반적인 오류 메시지 **********************/
    public static final int INTERNAL_SERVER_ERROR = 10000; // 서버 내부 오류
}
